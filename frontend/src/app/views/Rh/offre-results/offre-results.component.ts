...
@Component({
  selector: 'app-offre-results',
  templateUrl: './offre-results.component.html',
  styleUrls: ['./offre-results.component.css']
})
export class OffreResultsComponent implements OnInit{
  @Input()
  get color(): string {
    return this._color;
  }
  ...
  ngOnInit(): void {this.getOffreResults();}
  private getOffreResults(){
